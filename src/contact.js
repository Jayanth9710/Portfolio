...
const stamenTonerTiles = 'https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png?api_key=<9091209f-a631-41b6-b5ab-76746082c2c6>';
...
<div className="form-group col-md-6">
  ...
  <div className="icons">
  <button href="https://twitter.com/kumarjayanth55"className="fa fa-twitter"/>
  <button href="https://www.instagram.com/_jay_dot/"className="fa fa-instagram"/>
  <button href="https://www.youtube.com/channel/UCv0Axkz6tZFx0DPOu7LpNfQ"className="fa fa-youtube"/>
  </div>
</form>
</div>
</>
